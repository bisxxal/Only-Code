  ...
  return (
    <main className=" flex">
      ...
      }
      {
        adminuser?.id !== alluser?.id ? null : (
           <div className=" w-[23%] border-[#ffffff39] border-[2px]  py-7 !pt-4 h-fit flex rounded-xl px-4 flex-col mx-auto mt-20">
            <Link className=" w-full inshadow border border-[white] rounded py-2 px-4 mt-3 " href="/update-profile"> Update Profile </Link>
            <Link className=" w-full inshadow border border-[white] rounded py-2 px-4 mt-3 " href="/analytices"> Analytices </Link>
      </div>
        )
      }

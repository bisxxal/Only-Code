...
function MediaShown({posts ,user ,adminuser , content }: PostProps) {
    const [showDisplay, setShowDisplay] = useState<boolean>(false) 
    // const [imageurl , setUrl] = useState<string>('')
    // const [isMedia, setIsMedia] = useState<string>('')
    ...
    console.log( data.like , data.date , data.imageurl , data.isMedia);
